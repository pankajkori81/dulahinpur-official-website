...
//   "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d17393.41366871999!2d82.0421460358186!3d26.092633641434507!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399a85e83b98a7d3%3A0xeacdf75737132397!2sDulhin%20Pur%2C%20Uttar%20Pradesh%20228159!5e1!3m2!1sen!2sin!4v1783239970122!5m2!1sen!2sin";

// const MAPS_DIRECTIONS_URL = "https://maps.app.goo.gl/9LrJDwz3zej7xBgRA";

// export default function VenueSection() {
//   return (
//     <section
//       id="venue"
//       className="relative py-24 px-4 flex flex-col items-center bg-black"
//     >
//       {/* Section label */}
...
//           }}
//         >
//           <div className="w-16 h-px bg-gradient-to-r from-transparent to-yellow-500/50" />
//           <span style={{ fontFamily: "'Cinzel Decorative', cursive" }}>VENUE</span>
//           <div className="w-16 h-px bg-gradient-to-l from-transparent to-yellow-500/50" />
//         </div>
//         <h2
...
//           }}
//         >
//           दुलहिनपुर, रामगंज बाज़ार, अमेठी, उत्तर प्रदेश
//         </p>
//       </div>
...
//             boxShadow:
//               "0 0 40px rgba(245,166,35,0.1), 0 20px 60px rgba(0,0,0,0.5)",
//           }}
//         >
...
//             title="Dulhin Pur location map"
//           />

//           {/* Gold border overlay ring — purely decorative */}
//           <div
...
//           {/* Get Directions button — bottom centre, above map */}
//           <div className="absolute bottom-4 left-0 right-0 flex justify-center pointer-events-none">
//             <a
//               href={MAPS_DIRECTIONS_URL}
//               target="_blank"
//               rel="noopener noreferrer"
//               className="flex items-center gap-2 rounded-full px-5 py-2.5 transition-all duration-300 hover:scale-105 pointer-events-auto"
//               style={{
//                 background: "linear-gradient(135deg, rgba(192,57,43,0.92) 0%, rgba(245,166,35,0.92) 100%)",
//                 backdropFilter: "blur(12px)",
//                 boxShadow: "0 4px 20px rgba(0,0,0,0.5), 0 0 16px rgba(245,166,35,0.25)",
...
//                 stroke="rgba(245,166,35,0.9)" strokeWidth="1.8">
...
//               }}>
//                 दुलहिनपुर गाँव<br />
//                 रामगंज बाज़ार, अमेठी<br />
//                 <span style={{ color: "rgba(245,166,35,0.6)", fontSize: "14px" }}>
//                   उत्तर प्रदेश — 228 159
//                 </span>
//               </p>
//             </div>
//           </div>
...
//                 lineHeight: 1.8,
//               }}>
//                 आगमन : सोमवार, १४ सितंबर २०२६<br />
//                 दैनिक आरती : संध्या ८:०० बजे<br />
//                 <span style={{ color: "rgba(245,166,35,0.6)", fontSize: "14px" }}>
//                   विसर्जन : रविवार, २० सितंबर २०२६
//                 </span>
//               </p>
//             </div>
//           </div>
...
//             >
//               <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
//                 stroke="rgba(255,120,80,0.9)" strokeWidth="1.8">
//                 <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.3h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 9a16 16 0 0 0 6 6l.91-.91a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 21.73 16.92z" />
//               </svg>
//             </div>
//             <div>
//               <p style={{
...
//           {/* Quick directions CTA — mobile friendly */}
//           <a
//             href={MAPS_DIRECTIONS_URL}
//             target="_blank"
//             rel="noopener noreferrer"
//             className="flex items-center justify-center gap-3 rounded-2xl py-4 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg"
//             style={{
//               background: "linear-gradient(135deg, rgba(72,8,16,0.9) 0%, rgba(48,6,22,0.95) 100%)",
//               border: "1px solid rgba(245,166,35,0.3)",
...
export default function VenueSection() {
  return (
    <section
      id="contact"
      className="relative py-24 px-4 flex flex-col items-center overflow-hidden bg-transparent"
      style={{ contentVisibility:"auto" }} // 🚀 Deep dark brown base
    >
      ...
      `}</style> */}
      {/* ── BACKGROUND AMBIENT GLOWS (Performance Friendly) ── */}
      {/* Top Left Burgundy Glow */}
      <div 
        className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] rounded-full pointer-events-none"
        style={{
          background: "radial-gradient(circle, rgba(83, 9, 9, 0.4) 0%, rgba(0,0,0,0) 70%)",
          zIndex: 0
        }}
      />
      {/* Bottom Right Gold/Brown Glow */}
      <div 
      ...
      />
      {/* Center Subtle Blue Hint (to match Hero section) */}
      <div 
        className="absolute top-[40%] left-[50%] -translate-x-1/2 w-[800px] h-[400px] rounded-full pointer-events-none"
        style={{
          background: "radial-gradient(circle, rgba(10, 41, 255, 0.03) 0%, rgba(0,0,0,0) 60%)",
          zIndex: 0
        }}
      />

      {/* ── SECTION HEADER ── */}
      <div className="relative z-10 mb-14 flex flex-col items-center gap-3">
        <div className="flex items-center gap-3 opacity-90">
          <div className="w-12 md:w-20 h-px bg-gradient-to-r from-transparent to-[#d4af37]" />
          <span 
            className="text-[#d4af37] text-xs md:text-sm tracking-[0.3em] uppercase font-semibold"
            style={{ fontFamily: "'Cinzel Decorative', cursive" }}
          >
            VENUE
          </span>
          <div className="w-12 md:w-20 h-px bg-gradient-to-l from-transparent to-[#d4af37]" />
        </div>
        
        <h2
          className="text-4xl md:text-5xl text-center font-bold mt-2"
          style={{
            fontFamily: "'Cinzel Decorative', cursive",
      ...
      <div className="relative z-10 w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div
          ...
          style={{
            ...
            boxShadow: "0 10px 40px rgba(0,0,0,0.8), 0 0 20px rgba(83, 9, 9, 0.4)",
          }}
        >
          <iframe
            src={MAPS_EMBED_SRC}
            ...
            style={{
              ...
              display: "block",
              minHeight: "420px",
              filter: "contrast(1.1) saturate(0.8) sepia(0.2) hue-rotate(-10deg) brightness(0.9)", // Blends map colors with theme
              transition: "filter 0.5s ease"
            }}
            className="group-hover:filter-none" // Map becomes normal color on hover
            allowFullScreen
            loading="lazy"
            referrerPolicy="strict-origin-when-cross-origin"
            title="Dulhin Pur location map"
          ...
          <div className="absolute bottom-6 left-0 right-0 flex justify-center pointer-events-none">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 rounded-full px-6 py-3 transition-all duration-300 hover:scale-105 hover:-translate-y-1 pointer-events-auto"
              style={{
                background: "linear-gradient(135deg, #530909 0%, #2d0000 100%)",
                boxShadow: "0 8px 25px rgba(0,0,0,0.8), 0 0 15px rgba(212, 175, 55, 0.3)",
        ...
        {/* ── RIGHT: Premium Info Cards Stack ── */}
        <div className="flex flex-col gap-5 justify-center">

          {/* Address Card */}
          <div
            className="rounded-2xl p-6 flex gap-5 items-start transition-transform duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(83,9,9,0.5)]"
            style={{
          ...
          >
            ...
            <div>
              <p style={{ fontFamily: "'Cinzel Decorative', cursive", color: "#d4af37", fontSize: "12px", letterSpacing: "0.15em", marginBottom: "6px" }}>
                VENUE ADDRESS
              </p>
              <p style={{ fontFamily: "'Cormorant Garamond', serif", color: "#F3E9D8", fontSize: "18px", lineHeight: 1.6 }}>
                दुलहिनपुर गाँव<br />
                रामगंज बाज़ार, अमेठी<br />
                <span style={{ color: "#E8D4B4", fontSize: "15px", opacity: 0.7 }}>
                  उत्तर प्रदेश — 228 159
                </span>
              </p>
            </div>
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontFamily: "'Cormorant Garamond', serif", color: "#F3E9D8", fontSize: "16px", lineHeight: 1.6 }}>
                आगमन : १४ सितंबर २०२६<br />
                राम कथा आयोजन : १८ सितंबर २०२६ <br/>
                हवन एवं भंडरा आयोजन : १९ सितंबर २०२६ <br/>
                विसर्जन : २० सितंबर २०२६ <br/>
       ...
       style={{
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontFamily: "'Cormorant Garamond', serif", color: "#F3E9D8", fontSize: "18px", lineHeight: 1.6 }}>
                पंकज कोरी <br />
                <a href="tel:+918169585355" className="hover:text-[#d4af37] transition-colors">
                  +91 [8169585355]
                </a><br />
                <a href="https://wa.me/918169585355" target="_blank" rel="noopener noreferrer" className="text-[#F5A623] hover:text-[#FFD700] transition-colors text-[16px]">
                  WhatsApp करें ↗
                </a>
              </p>
            </div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 flex items-center justify-center gap-3 rounded-xl py-4 transition-all duration-300 hover:scale-[1.02]"
            style={{
              background: "transparent",
          ...
          >
            <span style={{ fontFamily: "'Cinzel Decorative', cursive", color: "#d4af37", fontSize: "12px", letterSpacing: "0.15em" }}>
              Open in Google Maps
            </span>
