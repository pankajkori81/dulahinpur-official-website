...
export default function InvitationSection() {
  // 🚀 PERFORMANCE FIX: Removed useRef and useEffect completely to stop heavy mouse-tracking calculations.
  ...
  return (
    ...
    >
      ...
      {/* --- 3D Card Container (Hover effect removed for performance) --- */}
