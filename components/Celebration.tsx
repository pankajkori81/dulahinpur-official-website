...
//     <section id="celebration" className="w-full flex justify-center items-center py-12 px-4 relative z-10 scroll-mt-24">
//     <div className="w-full flex justify-center items-center py-12 px-4 relative z-10">
      
//       {/* 
//         --- OUTER CARD CONTAINER ---
//         * Background: Deep rich maroon/brown gradient to match traditional cards while blending with your dark website.
//         * Shadow: Golden glow effect around the card.
//       */}
//       <div className="relative w-full max-w-lg bg-gradient-to-b from-[#3a0a0f] via-[#520c13] to-[#2d070a] p-4 md:p-6 rounded-lg shadow-[0_0_40px_rgba(212,175,55,0.15)] border border-[#d4af37]/30">
        
//         {/* 
//           --- INNER GOLDEN BORDER ---
//           Creates that classic double-border traditional wedding/invitation card look.
//         */}
//         <div className="relative border-2 border-[#d4af37] border-opacity-70 p-6 md:p-10 rounded text-center flex flex-col items-center">
          
//           {/* Corner Ornaments (Simple CSS implementation for traditional look) */}
//           <span className="absolute top-2 left-2 w-4 h-4 border-t-2 border-l-2 border-[#d4af37]"></span>
//           <span className="absolute top-2 right-2 w-4 h-4 border-t-2 border-r-2 border-[#d4af37]"></span>
//           <span className="absolute bottom-2 left-2 w-4 h-4 border-b-2 border-l-2 border-[#d4af37]"></span>
//           <span className="absolute bottom-2 right-2 w-4 h-4 border-b-2 border-r-2 border-[#d4af37]"></span>

//           {/* Top Ganesh Ji Logo (Replace src with your actual Ganesha logo if you have one) */}
//           <div className="mb-4">
//             {/* Using a text symbol as placeholder. You can replace this div with an <Image /> of golden Ganesha */}
//             <h1 className="text-4xl md:text-5xl text-[#d4af37]">ॐ</h1>
//           </div>

//           <h2 className="text-xl md:text-2xl font-bold text-[#F3E9D8] mb-2 font-[family-name:var(--font-yatra)]">
//             ॥ श्री गणेशाय नमः ॥
//           </h2>

//           {/* Decorative Divider */}
//           <div className="w-3/4 h-px bg-gradient-to-r from-transparent via-[#d4af37] to-transparent mb-6"></div>

//           {/* 
//             --- INVITATION TEXT --- 
//             Refined for a more welcoming and community-focused tone.
//           */}
//           <p className="text-[#E8D4B4] text-base md:text-lg leading-relaxed mb-8 font-[family-name:var(--font-mukta)]">
//             आपका स्नेह और आशीर्वाद हमें अत्यंत प्रिय है। <br className="hidden md:block" />
//             इस मंगल अवसर पर हम आप सभी को सपरिवार <br className="hidden md:block" />
//             बप्पा के दर्शन एवं महाप्रसाद हेतु सादर आमंत्रित करते हैं।
//           </p>

//           {/* Decorative heart/swastik divider */}
...
//           {/* 
//             --- KARYAKRAM RUPREKHA (SCHEDULE) --- 
//             Edit dates and times here as per your actual schedule.
//           */}
//           <h3 className="text-lg md:text-xl font-bold text-[#d4af37] mb-4 underline underline-offset-4 decoration-[#d4af37]/50 font-[family-name:var(--font-yatra)]">
//             -: कार्यक्रम रूपरेखा :-
//           </h3>
          
//           <div className="flex flex-col gap-3 text-[#E8D4B4] text-sm md:text-base mb-8 font-[family-name:var(--font-mukta)]">
//             <p><span className="text-[#d4af37] font-semibold">आगमन दिवस :</span> सोमवार, १४ सितंबर २०२६</p>
//             <p><span className="text-[#d4af37] font-semibold">दैनिक आरती :</span> सध्या ८:०० बजे</p>
//             <p><span className="text-[#d4af37] font-semibold">भजन संध्या :</span> बुधवार, १६ सितंबर २०२६</p>
//             <p><span className="text-[#d4af37] font-semibold">विसर्जन :</span> गुरुवार, २0 सितंबर २०२६</p>
//           </div>

//           {/* Decorative Divider */}
//           <div className="w-full h-px bg-gradient-to-r from-transparent via-[#d4af37]/40 to-transparent mb-6"></div>

//           {/* 
//             --- AYOJAK & ADDRESS --- 
//           */}
//           <div className="text-center w-full font-[family-name:var(--font-mukta)]">
//             <h4 className="text-base md:text-lg text-[#F3E9D8] mb-2">
//               <span className="text-[#d4af37] font-bold">आयोजक :</span> दुलहिनपुर गणेश उत्सव पूजा समिति
//             </h4>
//             <p className="text-sm md:text-base text-[#D9CEDD]">
//               <span className="text-[#d4af37] font-bold">स्थान :</span> दुलहिनपुर, रामगंज बाज़ार
//             </p>
//           </div>
...
const schedule = [
  {
    icon: "🪔",
    label: "आगमन दिवस",
    value: "सोमवार, १४ सितंबर २०२६",
    accent: "#F5A623",
  },
  {
    icon: "🔔",
    label: "दैनिक आरती",
    value: "संध्या ८:०० बजे",
    accent: "#FFD700",
  },
  {
    icon: "📖",
    label: "राम कथा आयोजन",
    value: "शुक्रवार,१८ सितंबर २०२६",
    accent: "#FF8C00",
  },
    {
    icon: "🔥",
    label: "हवन एवं भंडरा आयोजन ",
    value: "शनिवार,१९ सितंबर २०२६ ",
    accent: "#FF8C00",
  },
  {
    icon: "🌊",
    label: "विसर्जन",
    value: "रविवार, २० सितंबर २०२६",
    accent: "#d4af37",
  },
];
...
export default function InvitationSection() {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const rotateX = ((y - cy) / cy) * -8; // Adjust intensity of tilt here
  ...
  {/* --- INVITATION HEADER SECTION --- */}
      <div className="relative z-10 flex flex-col items-center gap-2 mb-8 md:mb-12 w-full text-center">
        ...
        {/* Top 'INVITATION' with fading lines */}
        <div className="flex items-center gap-3 md:gap-4 opacity-90">
          ...
          <span className="text-[#d4af37] text-xs md:text-sm tracking-[0.3em] uppercase font-semibold">
            Invitation
          </span>
        ...
        {/* Main Text */}
        <h2 
          className="text-3xl md:text-5xl font-bold mt-2 tracking-wide leading-normal py-2 px-4"
          style={{
            fontFamily: "var(--font-yatra), cursive", /* आपकी वेबसाइट का मौजूदा फॉन्ट */
            background: "linear-gradient(to bottom, #FFF0B3 0%, #F5A623 100%)",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent",
            filter: "drop-shadow(0px 4px 6px rgba(0,0,0,0.8))" /* डार्क बैकग्राउंड पर टेक्स्ट को उभारने के लिए शैडो */
          }}
        >
         आप सभी आमंत्रित है 
        </h2>
    ...
    {/* 3D Card Container */}
      <div
        ref={cardRef}
        className="relative w-full max-w-[500px] mx-auto mt-5  transition-transform duration-300 cursor-default"
      ...
      >
        ...
        {/* --- NEW BLACK CARD WITH ANIMATED DOT --- */}
        <div className="outer-wrapper shadow-2xl">
          <div className="moving-dot" />

          <div className="inner-card">
            <div className="ray" />
            <div className="card-line topl" />
            <div className="card-line leftl" />
            <div className="card-line bottoml" />
            <div className="card-line rightl" />

            {/* --- CONTENT CONTAINER (Kept exactly as you provided) --- */}
            <div className="relative z-10 px-6 py-10 md:px-10 flex flex-col items-center text-center w-full">
              ...
              <div className="mb-4">
                <h1 
                  ...
                  style={{
                    background: "linear-gradient(to bottom, #FFF0B3, #d4af37, #997A00)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
              ...
              <h2 className="text-xl md:text-2xl font-bold text-[#F3E9D8] mb-2 font-[family-name:var(--font-yatra)] tracking-wide">
                ॥ श्री गणेशाय नमः ॥
              </h2>
              ...
              {/* Swastik Divider */}
              <div className="flex items-center gap-3 mb-6 text-[#d4af37] opacity-80">
              ...
              {/* --- KARYAKRAM RUPREKHA (SCHEDULE) --- */}
              <h3 className="text-lg md:text-xl font-bold text-[#d4af37] mb-6 tracking-wider font-[family-name:var(--font-yatra)]">
                -: कार्यक्रम रूपरेखा :-
              </h3>
              ...
              <div className="w-full flex flex-col gap-4 mb-8">
                {schedule.map((item, i) => (
                  ...
                  >
                    ...
                    <div className="text-left font-[family-name:var(--font-mukta)]">
                      <span className="text-[#d4af37] font-semibold text-sm md:text-base mr-2">{item.label} :</span>
                      <span className="text-[#E8D4B4] text-sm md:text-base">{item.value}</span>
                    </div>
                  </div>
                ))}
              </div>
              ...
              {/* --- AYOJAK & STHAN --- */}
              <div className="text-center w-full mt-6 font-[family-name:var(--font-mukta)]">
                <h4 className="text-base md:text-lg text-[#F3E9D8] mb-2">
                  <span className="text-[#d4af37] font-bold tracking-wide">अध्यक्ष एवं आयोजक :</span> श्री राजेंद्र कोरी
                </h4>
                <p className="text-sm md:text-base text-[#D9CEDD]">
                  <span className="text-[#d4af37] font-bold tracking-wide">स्थान :</span> दुलहिनपुर, रामगंज बाज़ार, अमेठी 
                </p>
              </div>
  ...
  return (
    <div className="flex items-center gap-3 w-3/4">
      ...
      <div className="flex items-center gap-1">
        <div className="w-1.5 h-1.5 rounded-full bg-[#d4af37] opacity-80" />
        <span style={{ color: "#d4af37", fontSize: "12px", opacity: 0.9 }}>❖</span>
        <div className="w-1.5 h-1.5 rounded-full bg-[#d4af37] opacity-80" />
      </div>
