...
/* ═══════════════════════════════════════════
   TYPES
═══════════════════════════════════════════ */
type FeedbackType = "दर्शन अनुभव" | "प्रसाद" | "आयोजन" | "सुझाव" | "";
...
function StarRating({
  ...
  const labels = ["", "निराशाजनक", "ठीक-ठाक", "अच्छा", "बहुत अच्छा", "अद्भुत 🙏"];
    ...
    <div className="flex flex-col items-center gap-3">
      ...
      <p
        style={{
          ...
          color: display > 0 ? "rgba(245,166,35,0.85)" : "rgba(245,166,35,0.35)",
          fontSize: "14px",
          fontStyle: "italic",
          minHeight: "20px",
      ...
      >
        {display > 0 ? labels[display] : "रेटिंग चुनें • Select rating"}
      </p>
    </div>
  );
}
...
/* ═══════════════════════════════════════════
   FEEDBACK TYPE CHIPS
═══════════════════════════════════════════ */
const FEEDBACK_TYPES: { value: FeedbackType; emoji: string }[] = [
  { value: "दर्शन अनुभव", emoji: "🙏" },
  { value: "प्रसाद",       emoji: "🍬" },
  { value: "आयोजन",        emoji: "🎉" },
  { value: "सुझाव",        emoji: "💡" },
];
...
function SuccessCard({ onReset }: { onReset: () => void }) {
  return (
    <div
      className="flex flex-col items-center gap-6 py-12 px-8 text-center"
    ...
    >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, rgba(72,8,16,0.9), rgba(48,6,22,0.95))",
...
//   };
  ...
  <section
      ...
      className="relative w-full overflow-hidden py-24 px-4 flex flex-col items-center gap-12"
    >
     ...
     <div className="relative z-10 flex flex-col items-center gap-3 text-center">
        <div
          ...
          style={{ color: "rgba(245,166,35,0.7)", letterSpacing: "0.25em", fontSize: "14px" }}
        >
          <div className="w-16 h-px" style={{ background: "linear-gradient(to right, transparent, rgba(245,166,35,0.5))" }} />
          <span style={{ fontFamily: "'Cinzel Decorative', cursive" }}>FEEDBACK</span>
        ...
        >
          Share Your Blessings • बप्पा के दर्शन का अनुभव सबके साथ बाँटें
        </p>
      </div>
      ...
      >
        ...
        {/* Top gold band */}
        <div style={{ height: "2px", background: "linear-gradient(90deg, #6B0A14, #C0392B, #F5A623, #FFD700, #F5A623, #C0392B, #6B0A14)" }} />
        ...
        {status === "success" ? (
          ...
          <form
            ...
            className="px-7 py-9 md:px-10 flex flex-col gap-6"
            noValidate
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                <label style={{ fontFamily: "'Cinzel Decorative', cursive", color: "rgba(245,166,35,0.7)", fontSize: "14px", letterSpacing: "0.05em" }}>
                  नाम • NAME *
                </label>
                <input
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  className="feedback-input"
                  type="text"
                  placeholder="कहाँ से? • From where?"
                  value={form.city}
            ...
            {/* ── Star Rating ── */}
            <div className="flex flex-col gap-2">
              <label style={{ fontFamily: "'Cinzel Decorative', cursive", color: "rgba(245,166,35,0.7)", fontSize: "14px", letterSpacing: "0.05em", textAlign: "center" }}>
                रेटिंग • RATING *
              </label>
              <div
                className="rounded-2xl py-5 flex items-center justify-center"
                style={{ background: "rgba(245,166,35,0.05)", border: "1px solid rgba(245,166,35,0.12)" }}
              >
                <StarRating
                  value={form.stars}
                  onChange={(n) => set("stars", n)}
                  disabled={isSubmitting}
                />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-wrap gap-2">
                {FEEDBACK_TYPES.map(({ value, emoji }) => (
                  <button
                    key={value}
                    type="button"
                    disabled={isSubmitting}
            ...
            <div className="flex flex-col gap-2">
              <label style={{ fontFamily: "'Cinzel Decorative', cursive", color: "rgba(245,166,35,0.7)", fontSize: "14px", letterSpacing: "0.05em" }}>
                संदेश • MESSAGE
                <span style={{ color: "rgba(245,166,35,0.7)", fontWeight: 400, marginLeft: "6px", fontSize: "9px" }}>
                  (वैकल्पिक • Optional)
                </span>
              </label>
              <textarea
                className="feedback-input"
                rows={4}
                placeholder="बप्पा के दर्शन का अनुभव साझा करें... • Share your experience..."
                value={form.message}
                onChange={(e) => set("message", e.target.value)}
                disabled={isSubmitting}
                maxLength={500}
              />
              <p style={{ fontFamily: "'Cormorant Garamond', serif", color: "rgba(245,166,35,0.3)", fontSize: "12px", textAlign: "right" }}>
            ...
            {errMsg && (
              ...
              >
                <p style={{ fontFamily: "'Cormorant Garamond', serif", color: "rgba(255,140,100,0.9)", fontSize: "14px" }}>
                  {errMsg}
                </p>
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="relative overflow-hidden rounded-full py-4 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg"
              style={{
                background: isSubmitting
                  ? "rgba(245,166,35,0.3)"
                  : "linear-gradient(135deg, #7B0A14 0%, #C0392B 40%, #F5A623 100%)",
                ...
                boxShadow: isSubmitting ? "none" : "0 8px 32px rgba(192,57,43,0.35)",
              }}
            >
              {isSubmitting ? (
                <span className="flex items-center justify-center gap-3">
                  <span
                    ...
                    style={{ borderColor: "rgba(255,220,150,0.4)", borderTopColor: "rgba(255,220,150,0.9)" }}
                  />
                  भेजा जा रहा है... • Sending...
                </span>
              ) : (
                " फीडबैक भेजें • Submit Feedback"
              )}
            </button>
            ...
            >
              आपका फीडबैक सुरक्षित है • Your feedback is private and goes directly to the organizer
            </p>
          </form>
        )}
